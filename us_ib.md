...
## US2 – Obtener destinos

**Como** sistema  
**Quiero** consultar los destinos  
**So that** los destinos se vean

### Endpoint
GET https://ibisservices.iberia.com/api/rdu-loc/rs/loc/v1/location/cities/destination
